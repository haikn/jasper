 ...
 * @author Albert
 */
public class Spectrometer extends OpticsPane {
    ...
    private double xoff=0.0, yoff=0.0, focal=1.0;
    ...
    static String logmessage="pattern Spectrometer xoff=%s yoff=%s focal=%s";
}
