...
public class LensPattern extends Lens {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(panelPattern, javax.swing.GroupLayout.PREFERRED_SIZE, 525, javax.swing.GroupLayout.PREFERRED_SIZE)
                //.addGap(10, 10, 10)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(panelPattern, javax.swing.GroupLayout.PREFERRED_SIZE, 303, javax.swing.GroupLayout.PREFERRED_SIZE)
                    )
    ...
    public void buttonGenerateActionUpdatePerformed(double x, double y, double f) {//GEN-FIRST:event_buttonGenerateActionPerformed
			PatternImage image = ((EduPatternJPanel)panelPattern).pimage; 
			image.updateLensParameter(x, y, f);
			image.paintLens();
                        updatePatternScreen1(x, y, f);
			//EduPatternTest.updateLensPattern(image, genLog());
                        //EduPatternTest.updateLensPatternPattern(image, genLog());
    }

    public void buttonGenerateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonGenerateActionPerformed
		if (parseArguments()) {
			PatternImage image = ((EduPatternJPanel)panelPattern).pimage; 
    ...
    public void buttonSecondGenerateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSecondGenerateActionPerformed
		if (parseArguments()) {
			PatternImage image = ((EduPatternJPanel)panelPattern).pimage; 
			image.updateLensParameter(xoff, yoff, focal);
			image.paintLens();
...
//    private javax.swing.JLabel labelYpos;
	...
	void updatePatternScreen1(double x, double y, double f) {
		PatternImage image = ((EduPatternJPanel)panelPattern).pimage; 
                System.out.println("panelPattern: " + panelPattern);
		//if (!imageGenerated) {
			image.updateLensParameter(x, y, f);
                        System.out.println("update x: " + x + " y " + y + " f: " + f);
//			image.paintLens();
//                        EduPatternTest.updateLensPatternPattern(image, genLog());
...
//            public void run() {
//                new LensPattern().setVisible(true);
//            }
//        });
//    }
}
